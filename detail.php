    ...
    if (isset($_SESSION['level'])) {
        if ($_SESSION['level'] == "user") { ?>
            <section class="section section--bg" data-bg="img/section/section.jpg">
                ...
                <div class="dropdown" style="width:60%;margin:auto; background-color:rgba(43,43,49,0.9); padding:30px; border-radius:10px;">
                    <div class="tanggal" style="color: white;width:100%;margin-bottom:20px; ">
                        <div class="sign__group">
                            <h1>Pilih Tanggal</h1>
                            <input type="date" class="sign__input" placeholder="<?= $daftar['tanggal'] ?>" name="tgl" value="<?= $daftar['tanggal'] ?>" style="background-color: rgb(50, 50, 50); margin-left: 50px;"><br>
                        </div>
                    </div>
                    <h1 style="color: white;">Studio</h1>
                    <div class="studio" style="width: 100%;padding:0 60px">
                        <li class="header__nav-item">
                            <a class="dropdown-toggle header__nav-link" href="#" role="button" id="dropdownMenuCatalog" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?= $daftar['nm_studio'] ?></a>
                        </li>
                    </div>
                    <h1 style="color: white;">Jam Tayang</h1>
                    <div class="studio" style="width: 100%;padding:0 60px">
                        <li class="header__nav-item">
                            <a class="dropdown-toggle header__nav-link" href="#" role="button" id="dropdownMenuCatalog" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?= $daftar['jam_tayang'] ?></a>
                        </li>
                    </div>
